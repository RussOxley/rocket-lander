...
export default function RocketLander({ onRoundComplete }) {
  ...
  return (
    ...
    >
      ...
      {phase === "playing" && (
        <div style={{ width: `${W}px`, maxWidth: "100%", margin: "0 auto" }}>
          {flightDataRef.current && (
            <div
            ...
            >
              <div style={{ display: "flex", gap: "14px", alignItems: "center" }}>
                ...
                <span>VEL <span style={{ color: flightDataRef.current.speedSafe ? "#4ade80" : flightDataRef.current.speedWarn ? "#fbbf24" : "#ef4444", fontWeight: 600 }}>{flightDataRef.current.speed}</span> <span style={{ color: "#64748b" }}>m/s</span></span>
              ...
              <div style={{ display: "flex", gap: "14px", alignItems: "center" }}>
                ...
                {decisionRef.current && (
                  <>
                    ...
                    <span style={{ color: "#4ade80" }}>{fmt$(wealth)}</span>
                    <span style={{ color: "#fbbf24" }}>RISK {fmt$(decisionRef.current.betAmount)}</span>
                  </>
                )}
              </div>
            </div>
